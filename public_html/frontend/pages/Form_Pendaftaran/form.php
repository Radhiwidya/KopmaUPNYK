...
<body>
    ...
    <div class="container mt-2">
        <div class="card mb-5" style="width: 100%;">
            <img src="assets/images/Brosur2.png" class="card-img-top">
        </div>
        <form enctype="multipart/form-data" action="../../../config/pendaftaran.php" method="POST">
            <div class="mb-3 input">
                <label for="nama" class="form-label">Nama</label>
                <input type="text" class="form-control" required id="nama" name="nama" value="<?php echo $nama ?>">
            </div>
            <div class="mb-3 input">
                <label for="nim" class="form-label">NIM</label>
                <input type="number" class="form-control" required id="nim" name="nim" value="<?php echo $nim ?>">
            </div>
            <div class="mb-3 input">
                <label for="no.wa" class="form-label">No. WhatsApp</label>
                <input type="number" class="form-control" required id="no_wa" name="no_wa" value="<?php echo $no_wa ?>">
            </div>
            <div class="mb-3 input">
                <label for="ttl" class="form-label">Tanggal Lahir</label>
                <input type="date" class="form-control" required id="ttl" name="ttl" value="<?php echo $ttl ?>">
            </div>
            <div class="mb-3 input">
                <label for="alamat" class="form-label">Alamat</label>
                <input type="text" class="form-control" required id="alamat" name="alamat" value="<?php echo $alamat ?>">
            </div>
            <div class="mb-3 input">
            ...
            <div class="mb-3 input">
                ...
                <input type="text" class="form-control" required id="jurusan" name="jurusan" value="<?php echo $prodi ?>">
            </div>
            <div class="mb-3 input">
            ...
            <div class="mb-3 input inputMenu hidden" id="inputMenu">
                ...
                <input type="file" class="form-control" id="bukti" name="bukti" value="<?php echo $bukti ?>">

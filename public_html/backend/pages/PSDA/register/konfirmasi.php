        ...
        <div class="pt-4">
            ...
            <div class="card mt-3">
                <div class="card-header text-white bg-secondary">
                    ...
                    <a href="konfirmasi" class="select1">Konfirmasi</a>
                    <a href="diterima" class="select2">Di terima</a>
                ...
                <div class="card-body" style="overflow-y: auto; width:95%;">
                    <table id="dataTable" class="table table-dark table-striped table-hover table-bordered" style="width: max-content;">
                        ...
                        <tbody>
                            <?php
                            $sql2       = "SELECT * FROM konfirmasi ORDER BY id ASC";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <a href="konfirmasi?op=tolak&id=<?php echo $id ?>" onclick="return confirm('Yakin tolak <?php echo $r2['nama'] ?> menjadi anggota?')"><button type="button" class="btn btn-danger"><i class="bi bi-trash"></i></button></a>
                                            <a href="konfirmasi?op=terima&id=<?php echo $id ?>" onclick="return confirm('Yakin terima <?php echo $r2['nama'] ?> menjadi anggota?')"><button type="button" class="btn btn-success"><i class="bi bi-check-lg"></i></button></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
